...
export async function createEmployee(companyId, data) {
    ...
    return prisma.$transaction(async (tx) => {
        ...
        // ===============================================
        let companyPerson = await tx.companyPerson.findUnique({
            where: {
                Company_idCompany_Person_idPerson: {
                    Company_idCompany: companyId,
                    Person_idPerson: person.idPerson,
                },
            },
            include: {
                employee: true,
        ...
        let roleId = null;
        if (data.role) {
            const role = await tx.userRoles.upsert({
                where: {
                    role: data.role,
                },
                create: {
        ...
        const employee = await tx.companyEmployee.create({
            data: {
                CompanyPerson_idCompanyPerson: companyPerson
                    .idCompanyPerson,
                UserRoles_idRole: roleId,
...
export async function listEmployees(companyId) {
    ...
    return employees.map((employee) => ({
        idCompanyEmployee: employee
            .idCompanyEmployee,
        isActive: employee
            .isActive,
        admissionDate: employee
            .admissionDate,
...
// =====================================================
export async function findEmployeeByCpf(companyId, cpf) {
...
// =====================================================
export async function updateEmployee(companyId, 
...
cpf, data) {
    ...
    // ==================================================
    const isEditingSelf = employee.idCompanyEmployee ===
        authenticatedEmployeeId;
    // ==================================================
