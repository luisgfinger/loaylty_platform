...
// CRIAR CLIENTE
// =====================================================
export async function createCustomer(companyId, employeeId, data) {
    // ==================================================
    // VERIFICAR EMPRESA
    // ==================================================
    ...
    return prisma.$transaction(async (tx) => {
        ...
        const customer = await tx.companyCustomer.create({
            data: {
                ...
                whatsappOptInAt: data.whatsappOptIn
                    ? new Date()
                    : null,
            },
            include: {
...
export async function updateCustomer(companyId, cpf, data) {
