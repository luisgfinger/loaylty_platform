...
export const rewardCategoryParamsSchema =
  z.object({
    companyId:
      z.coerce
        .number()
...
export const createRewardCategorySchema =
  z.object({
    name:
      z.string()
        .trim()
...
export const updateRewardCategorySchema =
  z.object({
    name:
      z.string()
        .trim()
...
export type CreateRewardCategoryInput =
  z.infer<
    typeof createRewardCategorySchema
  >;

export type UpdateRewardCategoryInput =
  z.infer<
    typeof updateRewardCategorySchema
  >;
