...
export function AppLayout({
  ...
  const isCashier =
    session?.employee.role === 'CAIXA'

  const visibleItems =
    isCashier
      ? items.filter(
          (item) =>
            item.path === '/app/purchases/new',
        )
      : items
    ...
    <div className="app-shell">
      ...
      >
            ...
            {visibleItems.map((item) => (
              <li key={item.path}>
                {item.available ? (
                  ...
                  <span
                    className="navigation-link is-unavailable"
                    aria-disabled="true"
                  >
                    {item.label}
        ...
        <p className="sidebar-company">
          <strong>Loyalty Platform</strong>
