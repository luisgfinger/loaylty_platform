...
} from "../../components/CustomerRewardsPanel";
...
export function CustomersPage() {
  ...
  // Exemplo:
  // /app/customers?create=1&cpf=123.456.789-00
  // ===================================================
